...
def Gross_K_means(Data_list, n_clusters, n_init, max_iter, weight):
	...
	plt.savefig('../output/User_DataDemo.png')
	plt.show()
	...
	####################################################################
	plt.savefig('../output/Users_Kmeans_N_{}_W2.png'.format(n_clusters))
	plt.show()
	####################################################################
...
if __name__ == "__main__":
	...
	Gross_K_means(Data_list =Data_list, n_clusters=9, n_init=500, max_iter=500, weight=1.0)
